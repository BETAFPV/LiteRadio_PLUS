...
#endif
	switch_A_temp = map(GetSwitchValue(SWA),993,2000,163,1811);
	switch_B_temp = map(GetSwitchValue(SWB),993,2000,163,1811);
	switch_C_temp = map(GetSwitchValue(SWC),993,2000,163,1811);
	switch_D_temp = map(GetSwitchValue(SWD),993,2000,163,1811);
...
void GetCRSFPackage(uint8_t* ChannelToCRSF)
{
uint16_t switch_A_temp;
	uint16_t switch_B_temp;
	uint16_t switch_C_temp;
  ...
  data_channel[4] =switch_A_temp;
  data_channel[5] =switch_B_temp;
  data_channel[6] =switch_C_temp;
  data_channel[7] =switch_D_temp;
  data_channel[8] =SBUS_VALUE;
  data_channel[9] =SBUS_VALUE;
  data_channel[10] =SBUS_VALUE;    
  data_channel[11] =SBUS_VALUE;  
  data_channel[12] =SBUS_VALUE;
  data_channel[13] =SBUS_VALUE;
  data_channel[14] =SBUS_VALUE;
  data_channel[15] =SBUS_VALUE;    
