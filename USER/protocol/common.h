...
#define FIRST_FLASH_MARK_ADDR           0x8007100

#define LITE_RADIO_HARDWARE_TYPE_ADDR   0x8007102
#define INTERNAL_RADIO_TYPE_ADDR        0x8007104
#define THROTTLE_ROCKER_POSITION_ADDR   0x8007106
#define HARDWARE_MAJOR_VERSION_ADDR     0x8007108
#define HARDWARE_MINOR_VERSION_ADDR     0x8007110
#define HARDWARE_PATCH_VERSION_ADDR     0x8007112

#define FIRMWARE_MAJOR_VERSION (0x01U)
#define FIRMWARE_MINOR_VERSION (0x02U)
#define FIRMWARE_PITCH_VERSION (0x03U)
typedef struct
{
